# Multi-Scale Cross-Attention Transformer Encoder for Event Calssification
 ...
 &emsp; A Transformer encoder model that incorporates different scale information via a multi-modal network with self and cross-attention layers. The package is based on arXiv:2401.00452 [hep-ph]. The current version of the package is very generic and spans three configurations as follows:
